...
def process_file(filename):
    ...
    <div id="waitlistModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 99999; background: rgba(17,17,17,0.85); align-items: center; justify-content: center; backdrop-filter: blur(8px);">
        <div style="background: #FFFFFF; padding: 35px 40px; border-radius: 8px; max-width: 600px; width: 90%; position: relative; max-height: 90vh; overflow-y: auto; text-align: left; box-shadow: 0 40px 100px rgba(0,0,0,0.4); font-family: 'Inter', sans-serif;">
            ...
            <h2 class="section-heading color-reveal" id="modalTitle" style="margin-top: 10px; margin-bottom: 10px; text-align: center; font-size: clamp(26px, 4vw, 34px);">Únete a Castle</h2>
            <p style="text-align: center; color: #111827; margin-bottom: 20px; line-height: 1.5; font-size: 15px;">Cuéntanos cómo quieres involucrarte.</p>
